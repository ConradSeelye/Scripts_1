...
WITH MembershipsCustomers ([membership_id], [customer_id], [firstname], [lastname], [DOB], [categoryname], [packagename], [Date Suspended From], [Date Suspended To], [dateeffective], [datesold], [dateexpires]) AS (
...
SELECT * FROM MembershipsCustomers